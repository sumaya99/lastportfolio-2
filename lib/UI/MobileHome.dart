            ...
            children: [
              ...
              Padding(
                ...
                child: Wrap(
                  children: [
                    Text(
                      "I'm a freelancer based in Erbi,Iraq specializing in building and designing applications, and everything in between.",
                      style: TextStyle(
                        color: Colors.grey,
                        fontSize: 15.0,
                        letterSpacing: 2.75,
                    ...
                    children: [
                      ...
                      Wrap(
                        children: [
                          CustomText(
                            text:
                                "Hello! I'm Sumaya, a Freelancer based in Erbil, Iraq.\n\nI enjoy creating things that live on the internet, whether that be applications, or design such as ui/ux desifn or graphic design or 2D animations or anything in between. My goal is to always build products that provide pixel-perfect, performant experiences.\n\n",
                            textsize: 16.0,
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                technology(
                                  context,
                                  "Grphic design(Adobe Illustrator , Photoshop)",
                                ),
                                technology(context, "HTML & (S)CSS"),
                                technology(context, "java, C++."),
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      method.launchURL("https://www.behance.net/suvishahoyi");
                    },
                  ),
                  IconButton(
                    icon: Icon(
                    ...
                    onPressed: () {
                      method.launchURL("https://www.shutterstock.com/g/suvvi");
                    },
                  ),
                  IconButton(
                    icon: Icon(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      method.launchURL("https://www.linkedin.com/in/suvi/");
                    },
                  ),
                  IconButton(
                    icon: Icon(
